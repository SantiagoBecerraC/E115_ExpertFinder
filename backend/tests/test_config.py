...
SERPAPI_API_KEY = os.environ.get(
    "SERPAPI_API_KEY", 
    "899dc7f820890c82a712f8a9d391c5744bfa1d952d2b11051f34c40d5cd89960"
)
GOOGLE_API_KEY = os.environ.get(
    "GOOGLE_API_KEY", 
    "AIzaSyBoGVFZtM94MKYx9j0oCtfMNiIOump09JQ"
)
...
SKIP_INTEGRATION_TESTS = os.environ.get("SKIP_INTEGRATION_TESTS", "False").lower() in ["true", "1", "yes"] and not USE_REAL_SERVICES
