...
class TestLinkedInVectorizer(unittest.TestCase):
    ...
    def test_initialize_gcp_client_failure(self):
        ...
        with patch('builtins.print') as mock_print:
            with patch('linkedin_data_processing.linkedin_vectorizer.ChromaDBManager') as mock_cm:
                ...
                mock_print.assert_any_call("Make sure GOOGLE_APPLICATION_CREDENTIALS environment variable is set correctly")
    ...
    def test_get_profiles_in_collection(self):
        ...
        self.mock_collection.get.return_value = {
            ...
            "metadatas": [
                {"original_id": "urn:li:1"},
                {"original_id": "urn:li:2"},
                {"original_id": "urn:li:3"}
            ]
        }
    ...
    def test_add_profiles_to_chroma(self):
        ...
        with patch.object(self.vectorizer, 'download_profiles_from_gcp'), \
             patch('glob.glob', return_value=['/tmp/some_profile.json']), \
             patch('json.load', return_value=sample_profile), \
    ...
    def test_add_profiles_to_chroma_empty(self):
        ...
        with patch.object(self.vectorizer, 'download_profiles_from_gcp', return_value=False), \
