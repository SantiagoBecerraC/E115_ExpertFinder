...
class TestMainEndpoints:
    ...
    def test_linkedin_search(self, mock_expert_finder):
        ...
        response = client.post(
            "/linkedin_search",
            json={"query": "python developer", "max_results": 5}
        )
    ...
    def test_linkedin_search_invalid_max_results(self):
        ...
        response = client.post(
            "/linkedin_search",
            json={"query": "python developer", "max_results": -1}
        )
    ...
    def test_scholar_search(self, mock_chroma_tool, mock_create_agent):
        ...
        response = client.post(
            "/scholar_search",
            json={"query": "machine learning research", "max_results": 5}
        )
    ...
    def test_search_all_experts(self, mock_chroma_tool, mock_create_agent, mock_expert_finder):
        ...
        response = client.post(
            "/search",
            json={"query": "expert search", "max_results": 5}
        )
    ...
    def test_version_database(self, mock_dvc_manager):
        ...
        response = client.post(
            "/api/data/version",
            json={"source": "linkedin", "profiles_added": 10, "description": "Test version"}
        )
