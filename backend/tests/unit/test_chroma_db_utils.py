...
class TestChromaDBManagerInitialization:
    ...
    def test_create_embedding_function(self):
        ...
        with patch('utils.chroma_db_utils.embedding_functions.SentenceTransformerEmbeddingFunction') as mock_embedding_cls, \
             patch('utils.chroma_db_utils.chromadb.PersistentClient') as mock_client_cls, \
             patch('utils.chroma_db_utils.ChromaDBManager._initialize_chromadb'):
    ...
    def test_initialization_with_defaults(self, mock_embedding_cls, mock_client_cls, temp_chroma_dir):
        ...
        with patch.dict(os.environ, {"CHROMADB_PATH": temp_chroma_dir}):
            ...
            mock_client.create_collection.assert_called_once_with(
                name="google_scholar",  # default name
...
class TestChromaDBManagerOperations:
    ...
    def test_collection_dimension_mismatch(self, mock_client_cls, mock_embedding_function):
        ...
        with patch('utils.chroma_db_utils.ChromaDBManager._create_embedding_function', 
    ...
    def test_query_metadata_document_mismatch(self, mock_client_cls, mock_chroma_client, mock_embedding_function):
        ...
        with patch('utils.chroma_db_utils.ChromaDBManager._create_embedding_function', 
            ...
            mismatch_warnings = [call for call in mock_warning.call_args_list 
                                if "Mismatch between documents and metadata" in call[0][0]]
    ...
    def test_create_collection_error(self, mock_client_cls, mock_chroma_client, mock_embedding_function):
        ...
        with patch('utils.chroma_db_utils.ChromaDBManager._create_embedding_function', 
            ...
            create_error_logs = [call for call in mock_error.call_args_list 
                               if "Error with collection initialization" in call[0][0]]
