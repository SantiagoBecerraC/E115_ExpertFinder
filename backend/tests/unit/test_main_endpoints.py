...
from main import app, Expert, convert_interests
...
class TestMainEndpointsAdvanced(unittest.TestCase):
    ...
    def setUp(self):
        ...
        client.add_mock_response(
            ...
            "/api/data/version", 
            200, 
            {"message": "Database successfully versioned", "success": True}
        )
        ...
        client.add_mock_response(
            "POST", 
            "/api/data/restore/abc123", 
            200, 
            {"message": "Version restored successfully", "success": True}
        )
        
        client.add_mock_response(
            "POST", 
            "/api/data/update_credibility_stats", 
            200, 
            {"message": "Credibility stats updated", "success": True}
        )
