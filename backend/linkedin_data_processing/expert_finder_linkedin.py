...
class ExpertFinderAgent:
    def __init__(self, chroma_dir="chroma_db", project_id=None, location="us-central1", reranker_model_name="BAAI/bge-reranker-v2-m3"):
        """
...
def test_search():
    ...
    if results3:
        for result in results3:
            print(f"  - {result['name']} ({result['education_level']}, {result['industry']}): {result['current_title']}")
